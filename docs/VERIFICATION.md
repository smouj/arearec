...
| Self-contained x64 publish | `PUBLISH_PORTABLE.ps1` produced a 78,897,710-byte ZIP with `AreaRec.exe`, `hostfxr.dll`, and matching SHA-256 (`4faefca90d2134d2929627f6e736212c66ab86df46f95c75d4d7307def715afe`); payload guards and packaged UI smoke pass | PASS locally |
