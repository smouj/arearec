...
| Self-contained x64 publish | `PUBLISH_PORTABLE.ps1` produced a 78,895,142-byte ZIP with `AreaRec.exe`, `hostfxr.dll`, and matching SHA-256 (`ae8e65ee9b69ffdd8455e43f0545de08d0be8f956a0155c11433f556eb4bff50`); packaged UI smoke passes | PASS locally |
